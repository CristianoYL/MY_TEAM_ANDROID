...
### Member
The Member Page shows the roster infomation. And if a user has admin previlege, such as Captains and Co-caps, he can manage the clubs through this page, including promoting members as admins, kicking member out and accepting new applicants to club.

### Map
The map page allows the user to see his current location as well as future game locations, and provide nacigation through Google Maps. 
...
Another important feature of the Map Page is online check-in. If you've played amatuer football, it is quite often the case that people won't show up on time as they said to. The online check-in feature allows the captains to have some prevision how his squad would turn up on a chilling Sunday game, and whether John Doe is indeed "5 minutes away" or just still in bed.

### Event
The Event Page will present all the events of the clubs. The lastest posting from the captains will show up here.
...
### Squad
The Squad Page is similar as the club's Member Page, however, not all club member may be playing this particular Tournament. Thus you may view the Squad as a sub-set of the Member of your club. The Captains also have admin previlege in the Squad Page.
