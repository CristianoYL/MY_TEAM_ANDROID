...
public class ClubActivity extends AppCompatActivity
    ...
    private String[] xData = {"Win","Draw","Loss"};
    private float[] yData = {34,4,8};
...
//        PieChartHelper pieChartHelper = new PieChartHelper(mChart,"Racer");
//        pieChartHelper.addData("WIN",34);
//        pieChartHelper.addData("DRAW",4);
//        pieChartHelper.addData("LOSS",5);
//        pieChartHelper.draw();
    }
