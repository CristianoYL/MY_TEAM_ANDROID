package com.example.cristiano.myteam.service.location;
...
public class FetchAddressIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String strAddress = intent.getStringExtra(Constant.ADDRESS_DATA_EXTRA);
        ...
        if (addresses == null || addresses.size()  == 0) {
            ...
            deliverResultToReceiver(Constant.SUCCESS_RESULT, results);
        }
    }
    ...
    private void deliverResultToReceiver(int resultCode, ArrayList<Address> addresses) {
        ...
        bundle.putParcelableArrayList(Constant.RESULT_DATA_KEY, addresses);
        mReceiver.send(resultCode, bundle);
    }

    private void deliverResultToReceiver(int resultCode, String errorMessage) {
        Bundle bundle = new Bundle();
        bundle.putString(Constant.RESULT_DATA_KEY, errorMessage);
        mReceiver.send(resultCode, bundle);
    }
}
